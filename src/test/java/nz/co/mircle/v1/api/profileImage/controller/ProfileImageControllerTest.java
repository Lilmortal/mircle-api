...
public class ProfileImageControllerTest {
    ...
    public void getDefaultProfileImage() throws Exception {
        ...
        MvcResult result = mvc.perform(get("/profileimage/default").contentType(MediaType.APPLICATION_JSON))
    ...
    public void givenIdThenUploadProfileImageToS3() throws Exception {
        ...
        MvcResult result = mvc.perform(MockMvcRequestBuilders.fileUpload("/profileimage/upload/s3")
                .file(file)
