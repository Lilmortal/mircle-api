...
public class UserSocialMediaController extends AbstractController{
    ...
    @Autowired
    public UserSocialMediaController(UserService userService, SocialMediaService socialMediaService, UserSocialMediaService userSocialMediaService) {
    ...
    public ResponseEntity createUserSocialMedia(@RequestParam("userId") Long userId, @RequestParam("socialMediaId") Long socialMediaId, @RequestParam("url") String url) {
