...
public class FriendController {
    ...
    public Message sendFriendRequest(FriendRequest friendRequest) {
        String message =
                String.format(
                        "%s %s wants to add you, do you accept?",
                        friendRequest.getFirstName(), friendRequest.getSurname());
        Message friendRequestMessage =
                new Message(friendRequest.getId(), friendRequest.getFriendId(), message);
