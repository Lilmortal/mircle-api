...
import nz.co.mircle.socialMedia.controller.SocialMediaController;
...
public class UserControllerTest {
    ...
    public void createAUser() throws Exception {
        ...
        mvc.perform(post("/user/create").content(json).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isCreated());
    }
}
